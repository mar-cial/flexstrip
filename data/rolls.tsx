...
export const rolls: Roll[] = [
...

  {
    ...
    uses: [
      ...
      {
        title: 'Paso rudo peatonal',
        icon: '',
      },
      {
        title: 'Puertas expuestas al exterior',
        icon: '',
      },
    ],
  },

  {
    ...
    uses: [
      {
        title: 'Seccionamiento de áreas refrigeradas',
        icon: '',
      },
      {
        title: 'Resistencia al frío',
        icon: '',
      },
      {
        title: 'Puertas colocadas en cuartos fríos',
        icon: '',
      },
    ],
  },

  {
    ...
    uses: [
      ...
      {
        title: 'Resistencia al frío y al uso rudo',
        icon: '',
      },
      {
        title: 'Puertas colocadas en cuartos fríos',
...

  {
    ...
    uses: [
      {
        title: 'Seccionamiento de áreas laborales',
        icon: '',
      },
      {
        title: 'Mayor resistencia a rayaduras y al uso en general',
        icon: '',
      },
      {
        title: 'Puertas para uso interior',
        icon: '',
      },
    ],
  },

  {
    ...
    uses: [
      {
        title: 'Seccionamiento de áreas laborales con actividades de soldadura',
        icon: '',
      },
      {
        title:
          'Protección de colaboradores que transitan por áreas de soldadura',
        icon: '',
      },
      {
        title: 'Puertas para uso interior',
...

  {
    ...
    uses: [
      ...
      {
        title: 'Paso peatonal en puertas de mayor anchura y altura',
        icon: '',
      },
      {
        title: 'Visión bidireccional',
...

  {
    ...
    uses: [
      ...
      {
        title: 'Paso rudo peatonal en puertas de mayor tamaño',
        icon: '',
      },
      {
        title: 'Puertas expuestas al exterior',
...

  {
    ...
    uses: [
      ...
      {
        title: 'Paso peatonal anti insectos',
        icon: '',
      },
      {
        title: 'Puertas expuestas al exterior',
